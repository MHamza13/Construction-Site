    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      {statCards.map((card, index) => {
        ...
        return (
          ...
          >
              {/* gradient overlay */}
            <div className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${card.bgGradient} opacity-10 rounded-full transform translate-x-8 -translate-y-8`}></div>
            
            <div className="relative p-6">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className={`inline-flex items-center justify-center w-12 h-12 bg-${card.color}-100 rounded-lg mb-4 group-hover:scale-110 transition-transform duration-200`}>
